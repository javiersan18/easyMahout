...
//		this(readResourceToTempFile("/org/apache/mahout/cf/taste/example/grouplens/ratings.dat"), COLON_DELIMTER);
//	}

	/**
	 * @param file, delimiter
	 *            File may be in different formats, value delimiter value delimiter value delimiter ...
	 *            Delimiter may be the commons "," "::" ";" etc.
	 * @throws IOException
...
//		try {
//			URL resourceURL = Resources.getResource(ExtendedDataModel.class, resourceName);
