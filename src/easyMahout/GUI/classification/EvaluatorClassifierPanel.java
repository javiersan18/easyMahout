...
public class EvaluatorClassifierPanel extends JPanel {
		...
		public EvaluatorClassifierPanel() {
		...
		public static void setTraining(String training) {
			tfTraining.setText(training);
		}
